...
public class CredentialController {
        ...
        public ResponseEntity<String> addCredential(@RequestBody Credential credential,
                ...
                return new ResponseEntity<String>(
                                credentialService.addCredential(credential, userId, password),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<Credential> getCredentials(@RequestParam Long credentialId,
                ...
                return new ResponseEntity<Credential>(
                                credentialService.retriveCredential(userId, credentialId, password),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<List<Credential>> getCredentialsPage(@PathVariable Long userId,
                ...
                return new ResponseEntity<List<Credential>>(credentialService.retriveCredential(
                                from, pageSize, userId, password), HttpStatus.OK);
        }

        @GetMapping("/metadata")
        public ResponseEntity<String> defaultKeyMetadata() {
                return new ResponseEntity<String>(
                                "{ salt : " + CredentialConstants.DEFAULT_SALT + ", iv : "
                                                + CredentialConstants.DEFAULT_IV + " }",
                                HttpStatus.OK);
        }
}
